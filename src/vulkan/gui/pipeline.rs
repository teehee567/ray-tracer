...
/// Creates a sampler optimized for GUI texture rendering with linear filtering.
...
/// Creates a descriptor set layout for GUI texture rendering.
/// The layout has a single combined image sampler binding for the fragment shader.
...
/// Creates a pipeline layout for GUI rendering.
/// Includes push constants for screen dimensions and the descriptor set layout for textures.
...
/// Creates a graphics pipeline for GUI rendering with blending enabled.
...
/// Creates a descriptor pool for GUI textures.
/// Supports up to MAX_GUI_TEXTURES combined image samplers.

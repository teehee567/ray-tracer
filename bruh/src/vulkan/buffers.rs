...
pub unsafe fn create_uniform_buffer(instance: &Instance, device: &Device, physical_device: &vk::PhysicalDevice) -> Result<(vk::Buffer, vk::DeviceMemory)> {
...
pub unsafe fn create_shader_buffers(instance: &Instance, device: &Device, physical_device: &vk::PhysicalDevice, size: u64) -> Result<(vk::Buffer, vk::DeviceMemory)> {

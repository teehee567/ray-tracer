...
pub unsafe fn run_command_buffer(device: &Device, data: &mut AppData, image_index: usize) -> Result<()> {
    ...
    device.cmd_pipeline_barrier(data.compute_command_buffer, vk::PipelineStageFlags::COMPUTE_SHADER, vk::PipelineStageFlags::BOTTOM_OF_PIPE, vk::DependencyFlags::empty(), &[] as &[vk::MemoryBarrier], &[] as &[vk::BufferMemoryBarrier], &[compute_barrier]);
